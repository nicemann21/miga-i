...
void CVision::DetermineOffsetXY(short rx, short ry, short size, long *offx, long *offy)
{
	short halfsize;	
	halfsize = size/2;
...
void CVision::LabelingPartialImage(long OffsetX, long OffsetY, long ImageSizeX, long ImageSizeY, short object)
{
...
int CVision::FindBall(short OffX, short OffY)
{
	//didiet
	short size=0;
...
void CVision::FindObjets(bool EvenOdd)
{
...
void CVision::UpdateLUTAllColor()
{

}

void CVision::UpdateLUTcolor(short *ptrNewColor, const int Color)
{

}

void CVision::SetFileConfig(const char * FileName)
{
	FILE *fp; 
	long	i;
...
void CVision::GetReference(int *HSI)
{
...
RECT CVision::GetBoundaryInfo(void)
{

	return rectBoundary;	
}

void CVision::GetBallPosition(int *Ballpoint)
{
...
void CVision::DetermineComponentsOfBigTeamColor()
{
...
void CVision::DetermineComponentsOfSmallIDColor(short whichRobot)
{
	short pixsize, whichcomponent;
//	char temp[100];
...
long CVision::MinDistanceFromBigTeamColor(short sX, short sY, short *spBigteam_nearst)
{
...
void CVision::FindHomeRobot(short whichRobot, short OffX, short OffY)
{
...
void CVision::GetHomeRobotPosition(RobotObj *HomeRobot)
{
	

}

void CVision::GlobalLabelingImage(long OffsetX, long OffsetY, long ImageSizeX, long ImageSizeY)
{
...
void CVision::FindOpponentRobot()
{
...
void CVision::DetermineComponentsOfOppBigTeamColor()
{
	short pixsize, whichcomponent;
...
void CVision::SearchFindOpponentRobot()
{
...
bool CVision::OpponentColorLabeling(long OffsetX, long OffsetY, long ImageSizeX, long ImageSizeY)
{
//		int iID;	 	// Choi.W.H  2000.02.18 
	short whichcomponent;
...
void CVision::FindOpponent(short whichRobot, short OffX, short OffY)
{
	short size, maxsize, candidate, whichcomponent;
	maxsize = 0;
	candidate =0;
...
void CVision::GetOpponentRobotPosition(RobotObj *OppRobot)
{
	for(int whichrobot=HOME1;whichrobot <= HGOALIE;whichrobot++)
...
void CVision::HomRobotTeamSearch()
{
...
int CVision::LocalTaemLabelingPartialImage(long OffsetX, long OffsetY, long ImageSizeX, long ImageSizeY)
{
...
bool CVision::TeamColorLocalLabeling(long OffsetX, long OffsetY, long ImageSizeX, long ImageSizeY)
{
...
void CVision::FindHomeRobot2Color(short whichRobot, short OffX, short OffY, POINT PositionOfTeamcolor, POINT TeamColorOffSet)
{
...
void CVision::IdComponentsCalculate(int object)
{
...
void CVision::SaveFileConfig(const char *FileName)
{
	FILE *fp; 
	long	i;
...
void CVision::GetFindFlag(int *GetFind)
{
...
BOOL CVision::NUM3_OR_NUM4_RobotIdColor_Check(short whichRobot, short OffX, short OffY, POINT PositionOfTeamcolor, POINT TeamColorOffSet)
{
...
void CVision::EstBallPointBackUp()
{
...
void CVision::GlobalComponetSet(int whichColor, int i, int j)
{
