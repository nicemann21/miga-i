// MyApplication.cpp : Defines the class behaviors for the application.
//
...
// CMyApplicationApp construction
...
// The one and only CMyApplicationApp object

CMyApplicationApp theApp;


// CMyApplicationApp initialization
