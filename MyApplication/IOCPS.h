...
public: 
	...
	CString GetHostIP();
	// Starts the server, //1406: MaxConnection diganti jadi 2 saja, asalnya 1201
	BOOL Start(int nPort=999,int iMaxNumConnections=2,int iMaxIOWorkers=1,int nOfWorkers=0,int iMaxNumberOfFreeBuffer=100,int iMaxNumberOfFreeContext=50,BOOL bOrderedSend=TRUE, BOOL bOrderedRead=TRUE,int iNumberOfPendlingReads=5);
